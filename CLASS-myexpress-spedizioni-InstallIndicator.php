...
include_once('CLASS-myexpress-spedizioni-Utility.php');

class CLASS_myexpress_spedizioni_InstallIndicator extends CLASS_myexpress_spedizioni_Utility {

	const optionInstalled = 'installed';
	const optionVersion = 'version';
